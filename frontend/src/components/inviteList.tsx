...
import {  List, ListSubheader,  TextField, Button, Stack } from '@mui/material';
    ...
    <List dense sx={{ width: '100%', maxWidth: 500, bgcolor: 'background.paper', borderRadius: "1rem" }} subheader={
      <>
        ...
        >
          ...
          <Button size="small" variant="contained" sx={{ color: "contrastText" }} 
          // onClick={handleInvite}
          >Invite</Button>
        </Stack>
      </>
    }>
      {/* {[1,2,3].map(({ invitee_email }: { invitee_email: string }) => {
